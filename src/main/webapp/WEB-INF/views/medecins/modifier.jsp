...
<div class="max-w-3xl mx-auto">
  <div class="mb-6 flex items-center justify-between">
    <div>
      <h1 class="text-2xl font-bold text-slate-900 tracking-tight flex items-center gap-2">
        <i class="ph ph-pencil-simple text-brand-600"></i> Modifier Médecin
      </h1>
      <p class="mt-1 text-sm text-slate-500">Mettez à jour les informations de ce praticien.</p>
    </div>
  ...
  <form method="post" action="${pageContext.request.contextPath}/medecins/edit" class="bg-white rounded-2xl shadow-sm border border-slate-200 overflow-hidden">
      ...
      <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
        <div>
          ...
          <div class="mt-2 relative">
            ...
            <input type="text" name="specialite" id="specialite" value="${medecin.specialite}" required class="block w-full rounded-xl border-0 py-2.5 pl-10 pr-3.5 text-slate-900 shadow-sm ring-1 ring-inset ring-slate-300 placeholder:text-slate-400 focus:ring-2 focus:ring-inset focus:ring-brand-600 sm:text-sm sm:leading-6 transition-all bg-white outline-none">
          </div>
        </div>
        <div>
