...
<div class="max-w-3xl mx-auto">
  <div class="mb-6 flex items-center justify-between">
    <div>
      <h1 class="text-2xl font-bold text-slate-900 tracking-tight flex items-center gap-2">
        <i class="ph ph-pencil-simple text-brand-600"></i> Modifier Patient
      </h1>
      <p class="mt-1 text-sm text-slate-500">Mettez à jour les informations de ce patient.</p>
    </div>
  ...
  <form method="post" action="${pageContext.request.contextPath}/patients/edit" class="bg-white rounded-2xl shadow-sm border border-slate-200 overflow-hidden">
    ...
    <div class="p-6 sm:p-8 space-y-6">
      ...
      <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
        <div>
          ...
          <div class="mt-2">
            <input type="text" name="nom" id="nom" value="${patient.nom}" required class="block w-full rounded-xl border-0 py-2.5 px-3.5 text-slate-900 shadow-sm ring-1 ring-inset ring-slate-300 placeholder:text-slate-400 focus:ring-2 focus:ring-inset focus:ring-brand-600 sm:text-sm sm:leading-6 transition-all bg-white outline-none">
          </div>
        </div>
        <div>
          <label for="prenom" class="block text-sm font-medium leading-6 text-slate-900">Prénom <span class="text-rose-500">*</span></label>
          <div class="mt-2">
            <input type="text" name="prenom" id="prenom" value="${patient.prenom}" required class="block w-full rounded-xl border-0 py-2.5 px-3.5 text-slate-900 shadow-sm ring-1 ring-inset ring-slate-300 placeholder:text-slate-400 focus:ring-2 focus:ring-inset focus:ring-brand-600 sm:text-sm sm:leading-6 transition-all bg-white outline-none">
          </div>
        </div>
      </div>
      ...
      <div>
        ...
        <div class="mt-2 relative">
          ...
          <input type="email" name="email" id="email" value="${patient.email}" required class="block w-full rounded-xl border-0 py-2.5 pl-10 pr-3.5 text-slate-900 shadow-sm ring-1 ring-inset ring-slate-300 placeholder:text-slate-400 focus:ring-2 focus:ring-inset focus:ring-brand-600 sm:text-sm sm:leading-6 transition-all bg-white outline-none">
        </div>
      </div>
      ...
      <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
        <div>
          ...
          <div class="mt-2 relative">
            ...
            <input type="tel" name="telephone" id="telephone" value="${patient.telephone}" class="block w-full rounded-xl border-0 py-2.5 pl-10 pr-3.5 text-slate-900 shadow-sm ring-1 ring-inset ring-slate-300 placeholder:text-slate-400 focus:ring-2 focus:ring-inset focus:ring-brand-600 sm:text-sm sm:leading-6 transition-all bg-white outline-none">
          </div>
        </div>
        <div>
          <label for="dateNaissance" class="block text-sm font-medium leading-6 text-slate-900">Date de Naissance</label>
          <div class="mt-2 relative">
            <input type="date" name="dateNaissance" id="dateNaissance" value="${patient.dateNaissance}" class="block w-full rounded-xl border-0 py-2.5 px-3.5 text-slate-900 shadow-sm ring-1 ring-inset ring-slate-300 placeholder:text-slate-400 focus:ring-2 focus:ring-inset focus:ring-brand-600 sm:text-sm sm:leading-6 transition-all bg-white outline-none">
          </div>
        </div>
      </div>
